...
complete A4 sequence through A4-EXIT, A4R, A5a/A5b, and A6 have evidence; A4 is
closed, coast distance is reproducible, the public deferred-NetCDF entry is
implemented/certified, and `A1-009` is closed by calibrated peak-RSS and stress
evidence. The single recommended next subphase is `0.3.0-A-EXIT — HARDENING
EXIT AND GATE B READINESS CERTIFICATION`. A6 does not itself complete 0.3.0-A
or satisfy Gate B. This placement does not authorize CF, vertical, provider,
multifile, remote, Zarr, or 3-D implementation.
