...
The next phase should open the 0.3 development cycle only after approving the
version, branch, and hardening-scope decisions in Gate A. It must not begin with
CF, vertical, or 3-D implementation. The first implementation work after that
gate is 0.3.0-A hardening.
