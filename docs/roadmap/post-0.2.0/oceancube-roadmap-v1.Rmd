...
CF semantics and explicit bounds. C1 implements DEC-030: thickness, volume,
and layer means share explicit vertical support, exact overlap, union coverage,
truthful derived bounds, and provenance. Its centre-derived compatibility path
is unchanged and uncertified, so B7-001 is PARTIALLY-CLOSED. `0.3.0-C` is now IN
PROGRESS. Static fields, annual WOA provider repair, pressure/height conversion,
parametric evaluation, integration, interpolation, multifile, remote, Zarr,
and 3-D behavior remain outside this authorization. The single recommended
next subphase is C2 under a separate scientific contract.
