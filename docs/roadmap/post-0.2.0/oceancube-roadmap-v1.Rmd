...
Gate A is satisfied and the 0.3 development cycle is open. A1/A2/A3a/A3b and
the complete A4 sequence through A4-EXIT have evidence; A4 is closed. The
single recommended next subphase is A4R, the coast-distance reproducibility
contract, before A5, because scientific results currently depend materially on
caller-global s2 state. 0.3.0-A remains incomplete and Gate B remains
unsatisfied. This placement does not authorize coast remediation inside
A4-EXIT or any CF, vertical, lazy-I/O, provider, or 3-D implementation.
