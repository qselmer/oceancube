...
source-build exclusion. C-EXIT now certifies the complete bounded C1-C10 chain
locally through DEC-040 without runtime or API change. Thus `0.3.0-C` is
COMPLETE/CERTIFIED LOCALLY — REMOTE EXIT PENDING. The single recommended next
phase, only after remote C-EXIT certification, is 0.3.0-D1 oceanographic
visualization architecture and contract; D1 has not started.
