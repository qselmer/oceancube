...
source-build exclusion. C-EXIT remains blocked pending remote C-GOVR
certification and a fresh bounded rerun, so `0.3.0-C` remains IN PROGRESS. The
single recommended next subphase, only after remote C-GOVR certification, is
the resumed vertical-ocean-science C-EXIT certification.
