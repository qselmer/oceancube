...
embedded as canonical state. B1 adds no dependency.
...
in the staged 0.3.0-B CF/interoperability block. B1 is COMPLETE and DEC-015 is
APPROVED — HYBRID. Gate B remains UNSATISFIED and vertical science is not
authorized. The single recommended next subphase is `0.3.0-B2 — CF METADATA
PRESERVATION ENGINE IMPLEMENTATION`. This placement does not itself implement
