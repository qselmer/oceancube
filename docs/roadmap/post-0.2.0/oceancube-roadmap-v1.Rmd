...
legacy migration, and explicit separation from QA and CF metadata. `A1-003` is
partially closed because design is complete but A4b runtime helpers and tests do
not yet exist. `DEC-019` remains approved. This does not complete 0.3.0-A or
satisfy Gate B.
...
chunk, and storage abstractions. CF-compliant NetCDF writing precedes or shares
...
Gate A is satisfied and the 0.3 development cycle is open. A1/A2/A3a/A3b/A4a
evidence is complete. The single preferred next subphase is A4b, implementation
and executable compatibility testing of provenance schema V1. 0.3.0-A remains
incomplete and must not advance to CF, vertical, lazy-I/O, or 3-D implementation
through A4a evidence alone.
