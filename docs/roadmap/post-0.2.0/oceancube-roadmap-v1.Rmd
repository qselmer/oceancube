...
simple supported-subset links without adding that dependency. Full grammar,
conformance, calendars, grid transformations, and formula evaluation remain
separate stages.
...
in the staged 0.3.0-B CF/interoperability block. B1 and B2 are COMPLETE and
DEC-015 is APPROVED — HYBRID IMPLEMENTED FOUNDATION. Gate B remains
UNSATISFIED and vertical science is not authorized. The single recommended
next subphase is `0.3.0-B3 — CF SUPPORTED-SUBSET INTERPRETATION AND
VALIDATION`. This placement does not itself implement
