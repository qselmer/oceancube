...
ready to begin the staged 0.3.0-B CF/interoperability block. Gate B remains
UNSATISFIED and vertical science is not authorized. The single recommended
next subphase is `0.3.0-B1 — CF METADATA FOUNDATION AND CF ENGINE DECISION`.
This placement does not itself implement CF, vertical, provider, multifile,
remote, Zarr, or 3-D behavior.
