...
A4b1, A4b2, and A4b3a evidence is complete. The single preferred next subphase
is A4b3b, table, geometry, and remaining producer provenance migration.
0.3.0-A remains incomplete and must not advance to CF, vertical, lazy-I/O, or
3-D implementation through A4b3a evidence alone.
