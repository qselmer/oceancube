...
3-D renderer, non-Gregorian representation, spatind dependency depth, fixture
governance, development version, and branch strategy remain open.
...
Gate A is satisfied and the 0.3 development cycle is open. A1/A2 and A3a
evidence are complete; the next real-data step is maintainer approval followed
by bounded A3b fixture creation. 0.3.0-A remains incomplete and must not advance
to CF, vertical, or 3-D implementation through this evidence alone.
