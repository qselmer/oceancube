...
complete A4 sequence through A4-EXIT, A4R, A5a/A5b, A6, and the global A-EXIT
review have evidence. `0.3.0-A` is COMPLETE/CERTIFIED and the repository is
in the staged 0.3.0-B CF/interoperability block. B1 through B5 are COMPLETE
locally; DEC-015 and the DEC-023 bounded core are approved and certified. Gate
B remains UNSATISFIED and vertical science is not authorized. The single
recommended next subphase is `0.3.0-B6 — CF CLIMATOLOGICAL TIME AND WOA23
ADJUDICATION`. It must resolve recurring climatological bins, bounds,
cell_methods, months-since meaning, and provider evidence without generic
duration-month guessing. B5 does not implement B6, vertical, static-field,
provider, multifile, remote, Zarr, or 3-D behavior.
