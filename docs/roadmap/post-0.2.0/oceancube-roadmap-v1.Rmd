...
A4b1, and A4b2 evidence is complete. The single preferred next subphase is
A4b3, complex, multi-input, table/geometry, and wrapper provenance migration.
0.3.0-A remains incomplete and must not advance to CF, vertical, lazy-I/O, or
3-D implementation through A4b2 evidence alone.
