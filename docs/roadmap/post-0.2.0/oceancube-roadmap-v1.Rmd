...
implemented/certified, and `A1-004` is closed. 0.3.0-A remains incomplete and
Gate B remains unsatisfied because `A1-009` peak-memory/stress evidence remains
open; A6 is next.
...
complete A4 sequence through A4-EXIT, A4R, A5a, and A5b have evidence; A4 is
closed, coast distance is reproducible, and the public deferred-NetCDF entry is
implemented/certified. The single recommended next subphase is A6, peak-memory,
stress and hardening performance certification. `DEC-018` is
implemented/certified and `A1-004` is closed; `A1-009` keeps 0.3.0-A incomplete
and Gate B unsatisfied. This placement does not authorize CF, vertical,
provider, multifile, remote, Zarr, or 3-D implementation.
