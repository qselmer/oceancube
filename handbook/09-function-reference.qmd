...
The 40 cards below comprise the frozen 38-export 0.2.0 API plus the approved
development exports `cube_open()` and `layer_integral()`. Canonical engines are
listed before compatibility helpers.
