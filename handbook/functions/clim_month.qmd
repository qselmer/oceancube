...
## Purpose
Estimate a two-stage monthly climatology through `cube_climatology()`.
...
## Metadata
Since 0.2.0, raw observations are averaged within each month-year before valid
yearly replicates receive equal climatological weights.
